        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/s0tefh9uMec")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/tamil_crazy_sani"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/SHIELDUPDATE")],
                     [InlineKeyboardButton(text="👨‍💻 Make", url="https://youtu.be/s0tefh9uMec"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
